...
# 2. Geometry: Maximize usage of the squircle
...
# Secondary Coral Peak
mu2 = 335
sigma2 = 46
amp2 = 205
y_coral = origin_y + amp2 * np.exp(-0.5 * ((x_vals - mu2) / sigma2) ** 2)

# 3. White Dashed Vertical Drop Lines (zorder=2)
...
# 6. Coordinate Axes on TOP Layer (zorder=5)
...
plt.savefig(png_path, dpi=dpi, transparent=True)
plt.savefig(svg_path, format='svg', transparent=True)
plt.close()

# Generate multi-resolution ICO file for Windows taskbar & app executable
img = Image.open(png_path)
img.save(ico_path, format='ICO', sizes=[(16,16), (24,24), (32,32), (48,48), (64,64), (128,128), (256,256)])
print(f"Generated official assets: {png_path}, {svg_path}, {ico_path}")
